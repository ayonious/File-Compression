...
public class Hunzipping
{
	...
	static int exbits1;					    //EXTRA BITS ADDED AT THE LAST TO MAKE THE FINAL ZIP CODE MULTIPLE OF 8
	static int putit;                       //    
	...
	static class TREE implements Comparable<TREE> 
	{
		...
		{
			if(this.freq1nc<T.freq1nc)return -1;
			if(this.freq1nc>T.freq1nc)return 1;
			return 0;
		}
	}
 ...
 * *********************************************************************************/
	...
	{
		int i;
		if(Root!=null) fredfs1(Root);
		for(i=0;i<300;i++) freq1[i]=0;
		for(i=0;i<300;i++) ss1[i]="";
		pq1.clear();
		bigone="";                  //THE BIG STRING
		temp="";                    //TEMPORARY STRING
		exbits1=0;					   //EXTRA BITS ADDED AT THE LAST TO MAKE THE FINAL ZIP CODE MULTIPLE OF 8
		putit=0;                      //    
		cntu=0;     
	}
/**********************************************************************************/
 ...
 * *********************************************************************************/
	public static void fredfs1(TREE now)
	{
			...
			if(now.Lchild!=null) fredfs1(now.Lchild);
			if(now.Rchild!=null) fredfs1(now.Rchild); 
	}
/**********************************************************************************/
 ...
 *********************************************************************************/
	...
	public static void dfs1(TREE now,String st)
	{
		...
		if(now.Lchild!=null) dfs1(now.Lchild,st+"0");
		if(now.Rchild!=null) dfs1(now.Rchild,st+"1");
	}
/**********************************************************************************/
 ...
 ******************************************************************************/		
	public static void readfreq1(String cc)
	{
		...
		if(cntu>1) dfs1(Root,"");   		        	// dfs1 to make the codes
...
//error if only <=one character in the input file
	...
	{
		initHunzipping();
		String arg1="in.txt.huffz";
		int n=arg1.length();
		readfreq1(arg1);
		createbin();
		String arg2=arg1.substring(0,n-6);
        //mame of the zipped file,name afterextracting
		readbin(arg1,arg2);
		initHunzipping();
	} 	*/
} 