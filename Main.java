...
package filecompression0805006;
...
public class Main extends JFrame implements  ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource() == ZH)
        {
            ...
            JOptionPane.showMessageDialog(null,"..........................Zipping Finished..........................","Status", JOptionPane.PLAIN_MESSAGE);
        ...
        else if(e.getSource() == UH)
        {
            ...
            JOptionPane.showMessageDialog(null,"..........................UnZipping Finished..........................","Status", JOptionPane.PLAIN_MESSAGE);
            redScore.setText(opened_file.length()+"Bytes");
    ...
    private static void createAndShowGUI() {
        ...
        helpItem.addActionListener(
                ...
                new ActionListener()
                {
                        ...
                        public void actionPerformed(ActionEvent event)
                        {
                                 JOptionPane.showMessageDialog(null,"Two algorithms are used for file compression"+"\n"
                                                                  +"1. Huffmans Codes"+"\n"
                                                                  +"2. Lampel-Ziv-Welch"+"\n"
                                                                  ...
                                                                  +"the same algorithm that you used for zipping ","How To...", JOptionPane.PLAIN_MESSAGE);
                        }
                }
        );
        ...
        aboutItem.addActionListener(
                ...
                new ActionListener()
                {
                        public void actionPerformed(ActionEvent event)
                        {
                                JOptionPane.showMessageDialog(null,"File Compresser is a software to zip and unzip files"+"\n"
                                                                  ...
                                                                  +"the supervision of Jesun Shahariar of Dept. of CSE, BUET.","About", JOptionPane.PLAIN_MESSAGE);
                        }
                }
        );
