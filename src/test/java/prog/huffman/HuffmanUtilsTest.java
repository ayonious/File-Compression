...
class HuffmanUtilsTest {
    ...
    void testBuildHuffmanTreeSingleCharacter() {
        ...
        // With single character, should return null but set the huffman code
        assertNull(root);
        assertEquals("0", huffmanCodes[65]);
    }
    ...
    void testBuildHuffmanTreeMultipleCharacters() {
        ...
        assertNotNull(root);
        assertEquals(6, root.frequency); // Total frequency: 3+2+1=6
    ...
    void testBuildHuffmanTreeStructure() {
        ...
        assertNotNull(root);
        assertEquals(39, root.frequency); // Total: 5+9+12+13=39
    }
    ...
    void testGenerateHuffmanCodesNodeCodes() {
        ...
        assertEquals("", root.code);
        assertEquals("0", left.code);
        assertEquals("1", right.code);
    }
